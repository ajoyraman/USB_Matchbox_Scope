...
//----------------------------------------------------------------------------------
//  initUART(); sets up the UART RX in Interrupt mode & Tx seems to be in polled mode
...
void initUart(void){
    ...
    IPC2bits.U1RXIP =4;//2;//Set UART1 RX Int Priority 0-7, 0=disabled 7=Highest
	//IPC2bits.U1TXIP =1;//TX Priority 2
    ...
    U1STAbits.UTXEN   = 1;   // Enable transmit
     ...
     //U1BRG = 155;// 9600 baud 12MHz Crystal
     //U1BRG = 12; // 115200 baud  12 MHz Crystal
